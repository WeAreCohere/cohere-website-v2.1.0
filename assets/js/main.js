        ...
        if ($('.counter-text-wrap').length) {
            $('.counter-text-wrap').appear(function () {
                ...
                var $t = $(this),
                    ...
                    isPound = $t.find(".count-text").attr("data-currency") === "pound";
        
                if (!$t.hasClass("counted")) {
                    $t.addClass("counted");
                    $({
                        countNum: $t.find(".count-text").text().replace('£', '')
                    }).animate({
                        countNum: n
                    }, {
                        duration: r,
                        ...
                        step: function () {
                            ...
                            $t.find(".count-text").text(isPound ? '£' + value : value);
                        },
                        complete: function () {
                            var value = this.countNum;
                            $t.find(".count-text").text(isPound ? '£' + value : value);
                        }
                    });
                }
